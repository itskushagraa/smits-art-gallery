...
export default function ArtworkInquiryForm({
    ...
    return (
        <form className="grid gap-5">
            ...
            {/* Submit (disabled for now; wiring later) */}
            <div className="pt-2">
                <button
                    type="button"
                    disabled
    ...
    return (
        <div className="relative">
            ...
            {open && (
                ...
                >
                    {options.map((opt, i) => {
                        const selected = value?.slug === opt.slug;
                        ...
                        return (
                            <button
                                ...
                                onMouseDown={(e) => {                         // <- close immediately on press
                                    e.preventDefault();                         //   don't let it bubble/submit
                                    onChange(opt);
                                    setOpen(false);
                                    requestAnimationFrame(() => btnRef.current?.focus());
                                }}
