...
export default function Card({ artwork }: { artwork: Artwork }) {
  ...
  return (
    ...
    >
      ...
      {/* Text block */}
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] items-start gap-x-2 gap-y-1 px-3 py-3">
        ...
        {/* Price: wraps on mobile; single-line, ellipsized on md+ */}
        <span className="mt-1 md:mt-0 md:row-span-2 md:self-start md:justify-self-end text-sm md:text-base text-[#0c1c17] md:whitespace-nowrap overflow-hidden text-ellipsis">
